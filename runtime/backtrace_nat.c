...
/* Debuginfo suffix-sharing jump words. A chain element whose first 32-bit
   ...
   for |target - here| <= 2^24 lies in [0x02000000, 0x03FFFFFF], keeping bit
   25 set. A record's bit 25 is always 0, just above its 23-bit name-struct
...
void caml_debuginfo_location(debuginfo dbg, /*out*/ struct caml_loc_info * li)
{
  ...
  /* Format of the two info words:
   ...
   |------------- info2 ------------||--------------- info1 -------------|
   1 lllllllllllllllllll mmmmmmmmmmmmmmmmmm 0 ffffffffffffffffffffffff k n
  63                  44                 26 25                       2 1 0
   Fully packed format:
   |-------------- info2 --------------||--------------- info1 -------------|
   0 llllllllllll mmm aaaaaa bbbbbbb ooooooooo 0 ffffffffffffffffffffffff k n
